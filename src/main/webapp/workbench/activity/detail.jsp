		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (index,value) {
					...
					// javascript:void(0); ---> 禁用超链接
                    // 动态生成的标签使用方法传参需要加引号 这里由于外层有引号所以内部加引号需要转义
					html += '<a class="myHref" href="javascript:void(0);" onclick="deleteRemark(\''+value.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>';
					html += '</div>';
					html += '</div>';
					html += '</div>';
				});
	...
	function deleteRemark(id) {
        $.ajax({
            ...
            success:function (data) {
                ...
                if (data.success){
                    // 删除成功的话 刷新一下页面
                    // showRemarkList(); 由于我们使用的before方法是追加记录 之前的记录没有删除 所以这里不能用showRemarkList
                    // 给要删除的记录div 加一个id 就是remark的id 直接删除指定的div即可
                    $("#"+id).remove();
                }else {
                    alert("删除失败");
                }
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" class="form-control" id="edit-marketActivityName" value="${act.name}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" class="form-control" id="edit-startTime" value="${startdate}">
                            </div>
                            <label for="edit-endTime" class="col-sm-2 control-label">结束日期</label>
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" class="form-control" id="edit-endTime" value="${enddate}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" class="form-control" id="edit-cost" value="${act.cost}">
                            </div>
                        </div>
